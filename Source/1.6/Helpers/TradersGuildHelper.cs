...
namespace BetterTradersGuild
{
    ...
    public static class TradersGuildHelper
    {
        ...
        // True when this map was built by a BTG garrison map generator (the custom
        // settlement pipeline or the smugglers den). This is the gate for BTG's
        // security-defeat rule, whose census only recognizes BTG-spawned defenders:
        // a TradersGuild settlement generated by vanilla (useCustomLayouts off) or
        // by another mod winning the generator swap must keep vanilla's defeat
        // verdict, or its garrison reads as zero and defeat fires on first blood.
        ...
        public static bool IsBTGGeneratedMap(Verse.Map map)
        {
            ...
            return generator == MapGenerators.BTG_SettlementMapGenerator
                || generator == MapGenerators.BTG_SmugglersDenMapGenerator;
        }
