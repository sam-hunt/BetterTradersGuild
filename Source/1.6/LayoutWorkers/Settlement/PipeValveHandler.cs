...
namespace BetterTradersGuild.LayoutWorkers.Settlement
{
    ...
    public static class PipeValveHandler
    {
        ...
        // valveDef: The valve ThingDef (may be null if mod not installed)
        // skipFirst: If true, leaves the first valve open for initial resource flow
        // Returns: Number of valves processed
        ...
        // valve: The valve Thing to process
        // Returns: True if valve was processed successfully
