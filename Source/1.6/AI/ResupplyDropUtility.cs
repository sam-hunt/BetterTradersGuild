...
namespace BetterTradersGuild.AI
{
    ...
    internal static class ResupplyDropUtility
    {
        ...
        /// <summary>Re-checks a single cell at drop time (it may have been blocked since scouting).</summary>
        ...
        /// <summary>
        /// Spawns a survival-meal cargo pod at <paramref name="cell"/>. The incoming
