...
namespace BetterTradersGuild.MapGeneration
{
    ...
    /// </summary>
    public class GenStep_BTGAutocannons : GenStep
    {
        /// <summary>
        ...
        public override void Generate(Map map, GenStepParams parms)
        {
            ...
            if (prefab == null)
            {
                Log.Warning("[Better Traders Guild] BTG_EntranceAutocannons prefab not found");
                return;
            }
            ...
            {
                SpawnEntrancePrefab(map, prefab, doorInfo);
            }

            if (perimeterDoors.Count > 0)
            {
                Log.Message($"[Better Traders Guild] Spawned entrance defenses at {perimeterDoors.Count} perimeter exit(s)");
            }
        }
        ...
        /// </summary>
        private void SpawnEntrancePrefab(Map map, PrefabDef prefab, PerimeterDoorInfo doorInfo)
        {
            ...
            // Spawn prefab using center-based positioning
            PrefabUtility.SpawnPrefab(prefab, map, prefabCenter, rotation, null);
        }
