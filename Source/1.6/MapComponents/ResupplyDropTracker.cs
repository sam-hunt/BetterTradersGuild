...
namespace BetterTradersGuild.MapComponents
{
    ...
    /// JobGiver_BTGCallResupply reads <see cref="CanResupplyNow"/> as a coarse pre-filter;
    /// the JobDriver re-reads it at job COMPLETION and only the first caller to finish calls
    /// <see cref="RecordResupply"/> and drops - later parallel callers (on other consoles)
    ...
    public class ResupplyDropTracker : MapComponent
    {
        ...
        /// <summary>Records that a resupply drop has landed, starting the cooldown.</summary>
