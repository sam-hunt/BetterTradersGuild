...
# that reshuffles our stock generators or hediff comps would show up in the
# dump even though it is not installed for most players. The pinned list is
# this mod + hard deps + every DLC our defs can MayRequire, matching the
...
# Per-repo constants. This script's structure mirrors the same
# L10nProbe-driven refresh flow used across this author's sidecar-bearing
# mods; this mod is not part of a probed family — it is the only
# sidecar-bearing mod in its own boot.
PACKAGE_ID = "shunter.bettertradersguild"
