...
#   <BTG_ResetToDefaults>...</BTG_ResetToDefaults>
...
def def_is_active(elem, active_packages):
    ...
    # absent from the sidecar and outside the l10n surface (e.g. the
    # Biotech-gated BTG_ConfigureStartingPawnsXenotypes ScenPartDef).
    # MayRequire = ALL listed packages must be active; MayRequireAnyOf = any.
...
def check_language(lang_dirs, english_keyed, sidecar, report):
    ...
    # root is not a language of its own: BTG_SilverInlayMelee's injections can
    # only live under 1.6/Mods/UniqueMeleeWeapons/Languages/<Lang>/ (MayRequire
