...
- Add tome to crew quarters bookshelf customizer if anomaly
- Mod integration: Choose where to land (independent traders scenario)
- Mod integration: VE weapons unique weapon types in crew/commander's quarters
